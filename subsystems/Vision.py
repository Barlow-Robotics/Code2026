...
from wpimath.geometry import Transform3d, Pose2d, Pose3d, Translation2d
...
class Vision(commands2.Subsystem):
    ...
    def find_pose_of_tag_closest_to_robot(
    ...
    def advantage_kit_logging(self):
        ...
        closest_pose = self.find_pose_of_tag_closest_to_robot(
