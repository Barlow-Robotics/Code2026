...
class VisionConstants:
    ...
    CLIMB_CAMERA_TO_ROBOT = Transform3d(
        Translation3d(
    ...
    ELEVATOR_CAM_TO_ROBOT = Transform3d(
        Translation3d(
    ...
    RIGHT_CLIMB_CAM_TO_ROBOT = Transform3d(
        Translation3d(
    ...
    # Note: You'll need to import your Vision class to use the filter method
    # For now, loading the standard field layout
    FIELD_TAG_LAYOUT = AprilTagFieldLayout.loadField(
        AprilTagField.k2025ReefscapeAndyMark
    )
    # If you need the filtered version, call Vision.filter_april_tag_field() after Vision is defined
    ...
    # AprilTag lists for different game pieces and alliances
